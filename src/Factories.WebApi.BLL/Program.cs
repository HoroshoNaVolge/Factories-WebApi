...
namespace Factories.WebApi.BLL
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // потому что при ошибочном JwtConfig выполн€ть программу дальше нет смысла
            ...
            builder.Services.AddSwaggerGen(c =>
            {
                ...
                // ƒобавьте определение безопасности (security definition) дл€ JWT Bearer token
                ...
                // ƒобавьте требование безопасности, чтобы использовать определение безопасности
